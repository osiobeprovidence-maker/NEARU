    ...
    >
      <div className="bg-white md:rounded-[2rem] border-y md:border border-zinc-200 shadow-sm shadow-zinc-200/50 p-6 sm:p-8 max-w-3xl mx-auto space-y-6 text-zinc-700 text-sm leading-relaxed pb-12">
        ...
        <section className="space-y-3">
          ...
          <p>
            When you use RALLY, we collect information you provide directly to us:
          </p>
        ...
        <section className="space-y-3">
          ...
          <p>
            RALLY does not publicly expose your live, continuous GPS coordinate path or your private home address. Distance indicators (e.g. "0.7 km away") use randomized approximate neighborhood coordinates. Precise venue locations are only shared when both parties mutually accept a RALLY.
          </p>
        </section>
