    ...
    >
      <div className="bg-white md:rounded-[2rem] border-y md:border border-zinc-200 shadow-sm shadow-zinc-200/50 p-6 sm:p-8 max-w-3xl mx-auto space-y-6 text-zinc-700 text-sm leading-relaxed pb-12">
        <div className="flex items-center gap-3 pb-6 border-b border-zinc-100">
          ...
          <div>
            <h3 className="text-xl font-bold text-zinc-900">lalao Community Agreement</h3>
        ...
        <section className="space-y-3">
          ...
          <p>
            By creating an account or using the lalao mobile and web applications, you agree to comply with and be bound by these Terms of Service. If you do not agree to these terms, please do not use the lalao platform.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            You must be at least 18 years old to create an account on lalao. To ensure neighborhood safety, lalao provides optional and required verification channels, including phone verification and National Identification Number (NIN) authentication. Providing false, stolen, or fraudulent identity information is strictly prohibited and grounds for immediate termination and reporting to relevant authorities.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            lalao is dedicated to fostering safe, spontaneous, and genuine peer-to-peer neighborhood connections. Users agree NOT to:
          </p>
        ...
        <section className="space-y-3">
          ...
          <p>
            lalao acts solely as a communication and discovery venue facilitating neighborhood interactions. lalao does not organize, control, or employ individual members. Users are solely responsible for exercising personal safety, verifying meeting spots, and adhering to local laws when meeting in real life.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            Where a RALLY includes cost-sharing, transport splitting, or mutual task assistance, users agree to transparent, fair handling of funds. lalao is not responsible for off-platform peer payment disputes, though confirmed fraudulent activity will result in permanent account banning and bad-standing records.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            lalao reserves the right to suspend, restrict, or terminate any account that violates our safety principles, terms of service, or community guidelines, with or without prior notice.
          </p>
        </section>
