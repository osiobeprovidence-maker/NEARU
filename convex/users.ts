...
export const getProfile = query({
  ...
  handler: async (ctx, args) => {
    ...
    const base = {
      ...
      isVerified: !!user.isVerified,
      verificationType: user.verificationType,
      isBlueVerified: Boolean(user.isBlueVerified === true || user.blueCheckStatus === "verified"),
      blueCheckStatus: user.blueCheckStatus || (user.isBlueVerified ? "verified" : "unverified"),
      verificationStatus: user.blueCheckStatus || (user.isBlueVerified ? "verified" : "unverified"),
